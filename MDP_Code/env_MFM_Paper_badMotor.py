...
class state_MFM_Paper(state_base):
	def __init__(self, index, time, M_BoP, H_Mot, I_cont):
		self.index  = index;
		self.time   = time;
		self.M_BoP  = M_BoP
		self.H_Mot  = H_Mot;
...
class env_MFM_Paper_badMotor(env_base):
	def __init__(self):
		...
		# t = 0
		self.H_Mot_Matrix[(H_Mot1.GetStringVal(), M_BoP1.GetStringVal(), I_Cont1.GetStringVal(), 0)]=[ 	((H_Mot1, 1), 0.60), ((H_Mot2, 1), 0.40)                     ]
		self.H_Mot_Matrix[(H_Mot1.GetStringVal(), M_BoP1.GetStringVal(), I_Cont2.GetStringVal(), 0)]=[ 	((H_Mot1, 1), 0.70), ((H_Mot2, 1), 0.30)                     ]
		self.H_Mot_Matrix[(H_Mot1.GetStringVal(), M_BoP1.GetStringVal(), I_Cont3.GetStringVal(), 0)]=[ 	                                          ((H_Mot3, 1), 1.00)]

		for t in range(1,3):
			self.H_Mot_Matrix[(H_Mot1.GetStringVal(), M_BoP1.GetStringVal(), I_Cont1.GetStringVal(), t)]=[ 	((H_Mot1, t+1), 0.60), ((H_Mot2, t+1), 0.40)                       ]
			self.H_Mot_Matrix[(H_Mot1.GetStringVal(), M_BoP1.GetStringVal(), I_Cont2.GetStringVal(), t)]=[ 	((H_Mot1, t+1), 0.70), ((H_Mot2, t+1), 0.30)                       ]
			self.H_Mot_Matrix[(H_Mot1.GetStringVal(), M_BoP1.GetStringVal(), I_Cont3.GetStringVal(), t)]=[                                                ((H_Mot3, t+1), 1.00)]
			self.H_Mot_Matrix[(H_Mot1.GetStringVal(), M_BoP2.GetStringVal(), I_Cont1.GetStringVal(), t)]=[ 	((H_Mot1, t+1), 0.45), ((H_Mot2, t+1), 0.55)                       ]
			self.H_Mot_Matrix[(H_Mot1.GetStringVal(), M_BoP2.GetStringVal(), I_Cont2.GetStringVal(), t)]=[ 	((H_Mot1, t+1), 0.80), ((H_Mot2, t+1), 0.20)                       ]
			...
			self.H_Mot_Matrix[(H_Mot2.GetStringVal(), M_BoP1.GetStringVal(), I_Cont1.GetStringVal(), t)]=[ 	                       ((H_Mot2, t+1), 0.45), ((H_Mot3, t+1), 0.55)]
			self.H_Mot_Matrix[(H_Mot2.GetStringVal(), M_BoP1.GetStringVal(), I_Cont2.GetStringVal(), t)]=[                         ((H_Mot2, t+1), 0.55), ((H_Mot3, t+1), 0.45)]
			self.H_Mot_Matrix[(H_Mot2.GetStringVal(), M_BoP1.GetStringVal(), I_Cont3.GetStringVal(), t)]=[                                                ((H_Mot3, t+1), 1.00)]
			self.H_Mot_Matrix[(H_Mot2.GetStringVal(), M_BoP2.GetStringVal(), I_Cont1.GetStringVal(), t)]=[                         ((H_Mot2, t+1), 0.55), ((H_Mot3, t+1), 0.45)]
			self.H_Mot_Matrix[(H_Mot2.GetStringVal(), M_BoP2.GetStringVal(), I_Cont2.GetStringVal(), t)]=[                         ((H_Mot2, t+1), 0.75), ((H_Mot3, t+1), 0.25)]
