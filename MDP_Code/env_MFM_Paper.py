...
class env_MFM_Paper(env_base):
	def __init__(self):
		...
		# t = 0
		self.I_Cont_Matrix[(H_Mot1.GetStringVal(), \
							action_100.GetStringVal(), 0)]=[ \
			((I_Cont1, 1), 0.99), ((I_Cont3, 1), 0.01)]
		self.I_Cont_Matrix[(H_Mot1.GetStringVal(), \
							action_80.GetStringVal(), 0)]=[ \
			((I_Cont2, 1), 0.99), \
			((I_Cont3, 1), 0.01)]

		# t = 1
		self.I_Cont_Matrix[(H_Mot1.GetStringVal(), \
							action_100.GetStringVal(), 1)]=[ \
			((I_Cont1, 2), 0.99), ((I_Cont3, 2), 0.01)]
		self.I_Cont_Matrix[(H_Mot2.GetStringVal(), \
							action_100.GetStringVal(), 1)]=[ \
			((I_Cont1, 2), 0.9), ((I_Cont3, 2), 0.1)]
		self.I_Cont_Matrix[(H_Mot3.GetStringVal(), \
							action_100.GetStringVal(), 1)]=[ \
			((I_Cont3, 2), 1.0)]

		self.I_Cont_Matrix[(H_Mot1.GetStringVal(), \
							action_80.GetStringVal(), 1)]=[ \
			((I_Cont2, 2), 0.9), ((I_Cont3, 2), 0.1)]
		self.I_Cont_Matrix[(H_Mot2.GetStringVal(), \
							action_80.GetStringVal(), 1)]=[ \
			((I_Cont2, 2), 0.85), ((I_Cont3, 2), 0.15)]
		self.I_Cont_Matrix[(H_Mot3.GetStringVal(), \
							action_80.GetStringVal(), 1)]=[ \
			((I_Cont3, 2), 1.0)]
		...
		# t = 2
		self.I_Cont_Matrix[(H_Mot1.GetStringVal(), \
							action_100.GetStringVal(), 2)]=[ \
			((I_Cont1, 3), 0.99), ((I_Cont3, 3), 0.01)]
		self.I_Cont_Matrix[(H_Mot2.GetStringVal(), \
							action_100.GetStringVal(), 2)]=[ \
			((I_Cont1, 3), 0.9), ((I_Cont3, 3), 0.1)]
		self.I_Cont_Matrix[(H_Mot3.GetStringVal(), \
							action_100.GetStringVal(), 2)]=[ \
			((I_Cont3, 3), 1.0)]

		self.I_Cont_Matrix[(H_Mot1.GetStringVal(), \
							action_80.GetStringVal(), 2)]=[ \
			((I_Cont2, 3), 0.9), ((I_Cont3, 3), 0.1)]
		self.I_Cont_Matrix[(H_Mot2.GetStringVal(), \
							action_80.GetStringVal(), 2)]=[ \
			((I_Cont2, 3), 0.85), ((I_Cont3, 3), 0.15)]
		self.I_Cont_Matrix[(H_Mot3.GetStringVal(), \
							action_80.GetStringVal(), 2)]=[ \
			((I_Cont3, 3), 1.0)]
		...
		# t = 0
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), H_Mot1.GetStringVal(), I_Cont1.GetStringVal(), 0)]=[ ((H_Mot1, 1), 1.0)]
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), H_Mot1.GetStringVal(), I_Cont2.GetStringVal(), 0)]=[      				((H_Mot2, 1), 1.0)]
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), H_Mot1.GetStringVal(), I_Cont3.GetStringVal(), 0)]=[                              			((H_Mot3, 1), 1.0)]

		# t = 1
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), H_Mot1.GetStringVal(), I_Cont1.GetStringVal(), 1)]=[ ((H_Mot1, 2), 0.7), ((H_Mot2, 2), 0.25), ((H_Mot3, 2), 0.05)]
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), H_Mot1.GetStringVal(), I_Cont2.GetStringVal(), 1)]=[ ((H_Mot1, 2), 0.8), ((H_Mot2, 2), 0.17), ((H_Mot3, 2), 0.03)]
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), H_Mot1.GetStringVal(), I_Cont3.GetStringVal(), 1)]=[                                      	((H_Mot3, 2), 1.0)]
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), H_Mot2.GetStringVal(), I_Cont1.GetStringVal(), 1)]=[ ((H_Mot1, 2), 0.6), ((H_Mot2, 2), 0.3),  ((H_Mot3, 2), 0.1)]
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), H_Mot2.GetStringVal(), I_Cont2.GetStringVal(), 1)]=[ ((H_Mot1, 2), 0.70), ((H_Mot2, 2), 0.25), ((H_Mot3, 2), 0.05)]
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), \
							H_Mot2.GetStringVal(), \
							I_Cont3.GetStringVal(), 1)]=[ \
			((H_Mot3, 2), 1.0)]
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), \
							H_Mot3.GetStringVal(), \
							I_Cont1.GetStringVal(), 1)]=[ \
			((H_Mot3, 2), 1.0)]
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), \
							H_Mot3.GetStringVal(), \
							I_Cont2.GetStringVal(), 1)]=[ \
			((H_Mot3, 2), 1.0)]
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), \
							H_Mot3.GetStringVal(), \
							I_Cont3.GetStringVal(), 1)]=[ \
		...
		self.H_Mot_Matrix[(M_BoP2.GetStringVal(), \
							H_Mot1.GetStringVal(), \
							I_Cont1.GetStringVal(), 1)]=[ \
			((H_Mot2, 2), 0.85), ((H_Mot3, 2), 0.15)]
		self.H_Mot_Matrix[(M_BoP2.GetStringVal(), \
							H_Mot1.GetStringVal(), \
							I_Cont2.GetStringVal(), 1)]=[ \
			((H_Mot2, 2), 0.8), ((H_Mot3, 2), 0.2)]
		self.H_Mot_Matrix[(M_BoP2.GetStringVal(), \
							H_Mot1.GetStringVal(), \
							I_Cont3.GetStringVal(), 1)]=[ \
			((H_Mot3, 2), 1.0)]
		...
		self.H_Mot_Matrix[(M_BoP3.GetStringVal(), \
							H_Mot1.GetStringVal(), \
							I_Cont1.GetStringVal(), 1)]=[ \
			((H_Mot3, 2), 1.0)]
		self.H_Mot_Matrix[(M_BoP3.GetStringVal(), \
		...
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), \
							H_Mot1.GetStringVal(), \
							I_Cont1.GetStringVal(), 2)]=[ \
			((H_Mot1, 3), 0.7), ((H_Mot2, 3), 0.25), ((H_Mot3, 3), 0.05)]
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), \
							H_Mot1.GetStringVal(), \
							I_Cont2.GetStringVal(), 2)]=[ \
			((H_Mot1, 3), 0.8), ((H_Mot2, 3), 0.17), ((H_Mot3, 3), 0.03)]
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), \
							H_Mot1.GetStringVal(), \
							I_Cont3.GetStringVal(), 2)]=[ \
			((H_Mot3, 3), 1.0)]
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), \
							H_Mot2.GetStringVal(), \
							I_Cont1.GetStringVal(), 2)]=[ \
			((H_Mot1, 3), 0.6), ((H_Mot2, 3), 0.3), ((H_Mot3, 3), 0.1)]
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), \
							H_Mot2.GetStringVal(), \
							I_Cont2.GetStringVal(), 2)]=[ \
			((H_Mot1, 3), 0.70), ((H_Mot2, 3), 0.25), ((H_Mot3, 3), 0.05)]
		self.H_Mot_Matrix[(M_BoP1.GetStringVal(), \
							H_Mot2.GetStringVal(), \
							I_Cont3.GetStringVal(), 2)]=[ \
			((H_Mot3, 3), 1.0)]
		...
		self.H_Mot_Matrix[(M_BoP2.GetStringVal(), \
							H_Mot1.GetStringVal(), \
							I_Cont1.GetStringVal(), 2)]=[ \
			((H_Mot2, 3), 0.85), ((H_Mot3, 3), 0.15)]
		self.H_Mot_Matrix[(M_BoP2.GetStringVal(), \
							H_Mot1.GetStringVal(), \
							I_Cont2.GetStringVal(), 2)]=[ \
			((H_Mot2, 3), 0.8), ((H_Mot3, 3), 0.2)]
		self.H_Mot_Matrix[(M_BoP2.GetStringVal(), \
							H_Mot1.GetStringVal(), \
							I_Cont3.GetStringVal(), 2)]=[ \
			((H_Mot3, 3), 1.0)]
		...
		# t = 0
		self.M_BoP_Matrix[(M_BoP1.GetStringVal(), \
							I_Cont1.GetStringVal(), 0)]=[ \
			((M_BoP1, 1), 1.0)]
		self.M_BoP_Matrix[(M_BoP1.GetStringVal(), \
							I_Cont2.GetStringVal(), 0)]=[ \
			((M_BoP2, 1), 1.0)]
		self.M_BoP_Matrix[(M_BoP1.GetStringVal(), \
							I_Cont3.GetStringVal(), 0)]=[ \
			((M_BoP3, 1), 1.0)]
		...
		self.M_BoP_Matrix[(M_BoP1.GetStringVal(), \
							I_Cont3.GetStringVal(), 1)]=[ \
			((M_BoP3, 2), 1.0)]
		self.M_BoP_Matrix[(M_BoP2.GetStringVal(), \
							I_Cont1.GetStringVal(), 1)]=[ \
			((M_BoP1, 2), 1.0)]
		self.M_BoP_Matrix[(M_BoP2.GetStringVal(), \
							I_Cont2.GetStringVal(), 1)]=[ \
		...
		self.M_BoP_Matrix[(M_BoP2.GetStringVal(), \
							I_Cont3.GetStringVal(), 1)]=[ \
			((M_BoP3, 2), 1.0)]
		self.M_BoP_Matrix[(M_BoP3.GetStringVal(), \
							I_Cont1.GetStringVal(), 1)]=[ \
			((M_BoP1, 2), 1.0)]
		self.M_BoP_Matrix[(M_BoP3.GetStringVal(), \
							I_Cont2.GetStringVal(), 1)]=[ \
		...
		while(len(next_state_queue) != 0):
			...
			for i in range(0, len(action_list)):
				...
				for i_I_Cont in range(len(self.I_Cont_Matrix[this_I_Cont_prior])):
					...
					this_H_Mot_prior = (this_M_BoP_str, this_H_Mot_str, \
						next_I_Cont_str, this_time);
					...
					for i_H_Mot in range(len(self.H_Mot_Matrix[this_H_Mot_prior])):
						...
						this_M_BoP_prior = (this_M_BoP_str, this_H_Mot_str, this_time);
						...
						for i_M_BoP in range(len(self.M_BoP_Matrix[this_M_BoP_prior])):
							...
							self.TransitionMatrix[this_state_str][this_action_str][next_state_str] \
								+= next_I_Cont_prob * next_H_Mot_prob * next_M_BoP_prob;
