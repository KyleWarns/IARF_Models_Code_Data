...
model BOP_DegradedPumps
  "BOP model in whcih feedwater pump undergoes performance degradation over time"
  ...
  Modelica.Blocks.Sources.RealExpression realExpression7(y=valveLinear2.m_flow)
    annotation (Placement(transformation(extent={{-56,-56},{-68,-42}})));
  IARF_Models.Components.MotorDegradation_Linear motorDegradation_Linear(
    start_time=3.1535e7,
    r=1,
    a=m_flow_FW_pump,
    s_nom=1500,
...
equation
  ...
  connect(resistance11.port_a, volume1.port_b[2]) annotation (Line(points={{-158.2,-16},
          {-178,-16},{-178,78.15},{-180.4,78.15}},
                                                 color={0,127,255}));
  ...
  connect(motorDegradation_Linear.m_flow, realExpression7.y) annotation (Line(points=
         {{-75.64,-50},{-75.64,-49},{-68.6,-49}}, color={0,0,127}));
  connect(motorDegradation_Linear.s_out, FW_pump.inputSignal) annotation (Line(
        points={{-87.88,-50},{-94,-50},{-94,-56},{-101,-56},{-101,-63.8}}, color={0,
          0,127}));
