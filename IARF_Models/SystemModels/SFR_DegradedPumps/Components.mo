...
package Components
  ...
  model IHTS_CBOP_DegradedPumps "IHTS and SG system with Controlled BOPs and Degraded Pumps"
  replaceable package Medium =
   ...
   replaceable package Medium_Ambient =
    ...
    TRANSFORM.Fluid.Machines.Pump_SimpleMassFlow pump(m_flow_nominal=450,
    ...
    IARF_Models.Components.SGs.SteamGenerator_DegradedPumps      SG1
      annotation (Placement(transformation(extent={{74,-10},{94,10}})));
    IARF_Models.Components.SGs.SteamGenerator_CBOP      SG2
  ...
  equation
    ...
    connect(volume_toAHX.port_b[1], SG1.port_a) annotation (Line(points={{42,39.75},{60,
            39.75},{60,-2},{74,-2}},   color={0,127,255}));
    connect(SG1.port_b, volume_fromAHX.port_a[1]) annotation (Line(points={{74,-6},{60,
            -6},{60,-60.25},{42,-60.25}},  color={0,127,255}));
    connect(volume_toAHX.port_b[2], SG2.port_a) annotation (Line(points={{42,40.25},{110,
            40.25},{110,-2},{120,-2}},    color={0,127,255}));
    connect(SG2.port_b, volume_fromAHX.port_a[2]) annotation (Line(points={{120,-6},{110,
            -6},{110,-59.75},{42,-59.75}},    color={0,127,255}));
