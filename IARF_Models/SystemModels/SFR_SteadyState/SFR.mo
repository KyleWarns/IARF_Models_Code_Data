...
model SFR
  ...
  package Medium_DRACS =
      TRANSFORM.Media.Fluids.Sodium.ConstantPropertyLiquidSodium
    "Primary heat system medium" annotation (Dialog(enable=false));
  Modelica.Units.SI.HeatFlowRate Q_total_shell=sum(IHX.shell.heatTransfer.Q_flows);
  Modelica.Units.SI.HeatFlowRate Q_total_tube=sum(IHX.tube.heatTransfer.Q_flows);
  Modelica.Units.SI.Temperature T_up=upperPlenum.medium.T;
  Modelica.Units.SI.Temperature T_lpo=lowerPlenum_outer.medium.T;
  Modelica.Units.SI.Temperature T_lp=lowerPlenum.medium.T;
  Modelica.Units.SI.SpecificHeatCapacity c_sodium=1280 "Specific Heat Capacity of Sodium - J/kg*K";
  Modelica.Units.SI.Power Q_IHX_Shell = (IHX.shell.state_b.T - IHX.shell.state_a.T)*IHX.shell.port_a.m_flow*c_sodium "Power Estimate in IHX Shell Side";
  Modelica.Units.SI.Power Q_IHX_Tube = (IHX.tube.state_b.T - IHX.tube.state_a.T)*IHX.tube.port_a.m_flow*c_sodium "Power Estimate in IHX Tube Side";
  TRANSFORM.Nuclear.CoreSubchannels.Regions_2 outerCore(
    ...
    redeclare model HeatTransfer =
        TRANSFORM.Fluid.ClosureRelations.HeatTransfer.Models.DistributedPipe_1D_MultiTransferSurface.Nus
        (Nus0={{
            ...
            data.PD_ratio) for j in 1:1} for i in 1:outerCore.geometry.nV}),
    Teffref_coolant=0.5*(data.T_IHX_inletPHTS + data.T_IHX_oultetPHTS),
    alpha_coolant=0,
  ...
  TRANSFORM.Nuclear.CoreSubchannels.Regions_2 innerCore(
    ...
    redeclare model HeatTransfer =
        ...
        (Nus0={{
            ...
            data.PD_ratio) for j in 1:1} for i in 1:innerCore.geometry.nV}),
    redeclare model Geometry =
        TRANSFORM.Nuclear.ClosureRelations.Geometry.Models.CoreSubchannels.Assembly
        (
        nPins=data.nPins_perSub,
  ...
  TRANSFORM.Nuclear.CoreSubchannels.Regions_1 reflector(
    ...
    redeclare model HeatTransfer =
        ...
        (Nus0={{
            ...
            data.PD_ratio) for j in 1:1} for i in 1:reflector.geometry.nV}),
    Q_nominal=0,
  ...
  TRANSFORM.Nuclear.CoreSubchannels.Regions_1 shield(
    ...
    redeclare model HeatTransfer =
        ...
        (Nus0={{
            ...
            data.PD_ratio) for j in 1:1} for i in 1:shield.geometry.nV}),
    Q_nominal=0,
    ...
    useLumpedPressure=true) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-60,-54})));
  TRANSFORM.Fluid.Volumes.MixingVolume upperPlenum(
    nPorts_a=4,
    redeclare package Medium = Medium_PHTS,
    ...
    use_HeatPort=true) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-20,18})));
  TRANSFORM.Nuclear.CoreSubchannels.Regions_2 outerCore_out(
    nParallel=data.nOuterCore,
    redeclare package Material_2 = TRANSFORM.Media.Solids.SS316,
    p_a_start=data.p_start,
    m_flow_a_start=data.m_flow_outer,
    ...
    T_start_2=data.T_start_hot,
    redeclare package Medium = Medium_PHTS,
    redeclare package Material_1 = TRANSFORM.Media.Solids.Helium,
    Q_nominal=0,
    ...
    redeclare model HeatTransfer =
        ...
        (Nus0={{
            ...
            data.PD_ratio) for j in 1:1} for i in 1:outerCore_out.geometry.nV}),
    useLumpedPressure=true) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-20,-26})));
  TRANSFORM.Nuclear.CoreSubchannels.Regions_2 outerCore_in(
    nParallel=data.nOuterCore,
    redeclare package Material_2 = TRANSFORM.Media.Solids.SS316,
    p_a_start=data.p_start,
    T_a_start=data.T_start_cold,
    ...
    redeclare model HeatTransfer =
        ...
        (Nus0={{
            ...
            data.PD_ratio) for j in 1:1} for i in 1:outerCore_in.geometry.nV}),
    Q_nominal=0,
    redeclare package Material_1 = TRANSFORM.Media.Solids.SS316,
    redeclare model Geometry =
        TRANSFORM.Nuclear.ClosureRelations.Geometry.Models.CoreSubchannels.Assembly
    ...
    useLumpedPressure=true) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-20,-82})));
  TRANSFORM.Nuclear.CoreSubchannels.Regions_2 innerCore_out(
    redeclare package Material_2 = TRANSFORM.Media.Solids.SS316,
    p_a_start=data.p_start,
    alpha_coolant=0,
    Teffref_fuel=data.T_start_hot,
    ...
    redeclare model HeatTransfer =
        ...
        (Nus0={{
            ...
            data.PD_ratio) for j in 1:1} for i in 1:innerCore_out.geometry.nV}),
    nParallel=data.nInnerCore,
    m_flow_a_start=data.m_flow_inner,
    redeclare package Material_1 = TRANSFORM.Media.Solids.Helium,
    Q_nominal=0,
    ...
    useLumpedPressure=true) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={2,-26})));
  TRANSFORM.Nuclear.CoreSubchannels.Regions_2 innerCore_in(
    redeclare package Material_2 = TRANSFORM.Media.Solids.SS316,
    p_a_start=data.p_start,
    T_a_start=data.T_start_cold,
    alpha_coolant=0,
    ...
    redeclare model HeatTransfer =
        ...
        (Nus0={{
            ...
            data.PD_ratio) for j in 1:1} for i in 1:innerCore_in.geometry.nV}),
    nParallel=data.nInnerCore,
    m_flow_a_start=data.m_flow_inner,
    Q_nominal=0,
    redeclare package Material_1 = TRANSFORM.Media.Solids.SS316,
    ...
    useLumpedPressure=true) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={2,-82})));
  TRANSFORM.Fluid.Volumes.ExpansionTank expansionTank(
    redeclare package Medium = Medium_PHTS,
    p_start=data.p_start,
  ...
  TRANSFORM.HeatExchangers.GenericDistributed_HX IHX(
  ...
  TRANSFORM.Fluid.Volumes.MixingVolume lowerPlenum_outer(
    redeclare package Medium = Medium_PHTS,
    p_start=data.p_start,
    redeclare model Geometry =
        TRANSFORM.Fluid.ClosureRelations.Geometry.Models.LumpedVolume.Cylinder (
          crossArea=data.crossArea_bottomprimaryVessel, length=data.height_bottomprimaryVessel),
    nPorts_b=3,
    use_HeatPort=true,
  ...
  TRANSFORM.Fluid.FittingsAndResistances.SpecifiedResistance resistance_toIHX(
      redeclare package Medium = Medium_PHTS, R=50)
    annotation (Placement(transformation(extent={{4,16},{24,36}})));
  TRANSFORM.Fluid.BoundaryConditions.Boundary_pT boundary_dummy(
    redeclare package Medium = Medium_PHTS,
    T=data.T_start_cold,
  ...
  TRANSFORM.Fluid.FittingsAndResistances.SpecifiedResistance resistance_toExpTank(
      redeclare package Medium = Medium_PHTS, R=1/data.m_flow_PHTS) annotation (
      Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-20,40})));
  TRANSFORM.Fluid.Pipes.GenericPipe_MultiTransferSurface downcomer[3](
    nParallel=2,
    redeclare package Medium = Medium_PHTS,
    p_a_start=data.p_start,
    T_a_start=data.T_start_cold,
    ...
    redeclare model Geometry =
        ...
        rotation=90,
        origin={30,-98})));
  TRANSFORM.Fluid.Machines.Pump_SimpleMassFlow pump_SimpleMassFlow[3](redeclare
      package Medium = Medium_PHTS, m_flow_nominal=data.m_flow_PHTS/3) annotation (
      Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=90,
        origin={30,-18})));
  TRANSFORM.Fluid.Volumes.MixingVolume lowerPlenum(
    nPorts_a=3,
    redeclare package Medium = Medium_PHTS,
    p_start=data.p_start,
    redeclare model Geometry =
        ...
        (V=1),
    nPorts_b=4,
    T_start=data.T_start_cold) annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=270,
        origin={-20,-128})));
  TRANSFORM.Fluid.FittingsAndResistances.SpecifiedResistance resistances[4](
      redeclare package Medium = Medium_PHTS, R={2e5/data.m_flow_shield,2e5/data.m_flow_reflector,
        1/data.m_flow_outer,1/data.m_flow_inner}) annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-20,-108})));
  TRANSFORM.HeatAndMassTransfer.DiscritizedModels.Conduction_2D vessel(
  ...
  TRANSFORM.HeatAndMassTransfer.BoundaryConditions.Heat.Temperature_multi boundary(nPorts=2,
      T=fill(data.T_ambientGround, boundary.nPorts))
    annotation (Placement(transformation(extent={{160,-118},{140,-98}})));
  TRANSFORM.HeatAndMassTransfer.Resistances.Heat.Convection convection[2](
      surfaceArea={vessel.geometry.crossAreas_1[1, 1],vessel.geometry.crossAreas_1[1,
        2]}, alpha={1000,100})
    annotation (Placement(transformation(extent={{82,-118},{102,-98}})));
  TRANSFORM.Fluid.FittingsAndResistances.SpecifiedResistance resistance_toExpTank1(
      redeclare package Medium = Medium_PHTS, R=1e6) annotation (Placement(
        transformation(
        extent={{10,-10},{-10,10}},
        rotation=180,
        origin={10,58})));
...
equation
  ...
  connect(outerCore_out.port_b, upperPlenum.port_a[3]) annotation (Line(points={{-20,-16},
          {-20,12},{-20.125,12}},          color={0,127,255}));
  ...
  connect(innerCore_out.port_b, upperPlenum.port_a[4])
    annotation (Line(points={{2,-16},{2,12},{-20.375,12}}, color={0,127,255}));
  ...
  connect(resistance_toExpTank.port_a, upperPlenum.port_b[1]) annotation (Line(
        points={{-20,33},{-20,24},{-19.75,24}},color={0,127,255}));
  ...
  connect(lowerPlenum.port_a[1:3], downcomer.port_b) annotation (Line(points={{
          -19.6667,-134},{-19.6667,-140},{-12,-140},{30,-140},{30,-140},{30,-140},{
          30,-108}},                    color={0,127,255}));
  ...
  connect(lowerPlenum.port_b[1:4], resistances.port_a) annotation (Line(points={{-19.625,
  ...
  connect(lowerPlenum_outer.port_b[1:3], pump_SimpleMassFlow.port_a)
    annotation (Line(points={{44,-67.6667},{40,-67.6667},{40,0},{30,0},{30,-8}},
        color={0,127,255}));
  ...
  connect(resistance_toIHX.port_a, upperPlenum.port_b[2]) annotation (Line(
        points={{7,26},{-20.25,26},{-20.25,24}},   color={0,127,255}));
  connect(resistance_toIHX.port_b, IHX.port_a_shell) annotation (Line(points={{21,26},
          {67.4,26},{67.4,12}},      color={0,127,255}));
  connect(IHX.port_b_shell, lowerPlenum_outer.port_a[1]) annotation (Line(
        points={{67.4,-8},{68,-8},{68,-68},{56,-68}},             color={0,127,255}));
  ...
  annotation (
    ...
    experiment(
      StopTime=26000,
      __Dymola_NumberOfIntervals=864,
